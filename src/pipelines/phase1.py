...
def main() -> None:
    ...
    quality = run_data_quality_checks(df, settings, "baseline_quality.json")
    ...
    print(f"Baseline pipeline complete: {len(df)} cleaned rows, {evaluation.summary['samples']} eval samples.")
